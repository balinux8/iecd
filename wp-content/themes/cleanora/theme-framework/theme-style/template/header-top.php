...
if ($cmsmasters_option['cleanora' . '_header_top_line']) {
	echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['cleanora' . '_header_top_height']) . '">' . 
		'<div class="header_top_outer">' . 
			'<div class="header_top_inner">';
				...
				if (
					$cmsmasters_option['cleanora' . '_header_top_line_add_cont'] == 'social' && 
					isset($cmsmasters_option['cleanora' . '_social_icons'])
				) {
					cleanora_social_icons();
				} elseif (
					$cmsmasters_option['cleanora' . '_header_top_line_add_cont'] == 'nav' && 
				...
				if ($cmsmasters_option['cleanora' . '_header_top_line_short_info'] !== '') {
