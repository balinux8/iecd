...
echo '<div class="header_mid' . ($cmsmasters_option['cleanora' . '_header_cust_html_hide'] == 0 ? ' cmsmasters_hide_html' : '')  . '" data-height="' . esc_attr($cmsmasters_option['cleanora' . '_header_mid_height']) . '">' . 
	'<div class="header_mid_outer">' . 
		'<div class="header_mid_inner">';
			...
			if (
				...
				if (
					$cmsmasters_option['cleanora' . '_header_add_cont'] == 'cust_html' && 
					$cmsmasters_option['cleanora' . '_header_add_cont_cust_html'] !== ''
				) {
					echo '<div class="slogan_wrap">' . 
						'<div class="slogan_wrap_inner">' . 
							'<div class="slogan_wrap_text">' . 
								stripslashes($cmsmasters_option['cleanora' . '_header_add_cont_cust_html']) . 
							'</div>' . 
						'</div>' . 
					'</div>';
				} elseif (
					$cmsmasters_option['cleanora' . '_header_add_cont'] == 'social' && 
					isset($cmsmasters_option['cleanora' . '_social_icons'])
				) {
					cleanora_social_icons();
				}
			} else if ($cmsmasters_option['cleanora' . '_header_styles'] == 'default') { 
				if ($cmsmasters_option['cleanora' . '_header_add_cont_cust_html'] !== '') {
					echo '<div class="slogan_wrap">' . 
						'<div class="slogan_wrap_inner">' . 
							'<div class="slogan_wrap_text">' . 
								stripslashes($cmsmasters_option['cleanora' . '_header_add_cont_cust_html']) . 
