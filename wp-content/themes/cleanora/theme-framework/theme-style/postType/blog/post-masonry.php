...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_post_masonry'); ?> data-category="<?php echo esc_attr($post_categs); ?>">
	<div class="cmsmasters_post_cont">
		...
		if ($cmsmasters_post_format == 'image') {
			...
			cleanora_post_type_slider(get_the_ID(), $cmsmasters_post_images, 'cmsmasters-blog-masonry-thumb', $slider_data);
		} elseif ($cmsmasters_post_format == '' && !post_password_required() && has_post_thumbnail()) {
			cleanora_thumb(get_the_ID(), 'cmsmasters-blog-masonry-thumb', true, false, true, false, true, true, false);
			...
			cleanora_post_type_video(get_the_ID(), $cmsmasters_post_video_type, $cmsmasters_post_video_link, $cmsmasters_post_video_links, 'cmsmasters-blog-masonry-thumb');
		}
		
		
		cleanora_post_heading(get_the_ID(), 'h2');
		...
		if ($date || $author) {
			echo '<div class="cmsmasters_post_cont_info entry-meta">';
				...
				$date ? cleanora_get_post_date('page', 'masonry') : '';
