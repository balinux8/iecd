...
if ($best == 'true') {
	...
	if ($best_bd_color != '') {
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_pricing_item_inner { ' . 
			"\n\t" . cmsmasters_color_css('border-color', $best_bd_color) . 
		"\n" . '} ' . "\n";
	}
	...
	if ($best_text_color != '') {
		...
		'#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .feature_list li, ' . 
		'#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .feature_list li *, ' . 
		'#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .feature_list li a, ' . 
