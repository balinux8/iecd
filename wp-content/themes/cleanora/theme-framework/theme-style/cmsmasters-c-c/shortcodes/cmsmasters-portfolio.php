...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Services', 'cleanora');

$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'cleanora');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'cleanora');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'cleanora');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'cleanora');
