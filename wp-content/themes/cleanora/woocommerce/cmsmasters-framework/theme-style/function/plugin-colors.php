...
function cleanora_woocommerce_colors($custom_css) {
...
/***************** Start {$title} WooCommerce Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_dynamic_cart_button,
	...
	{$rule}.link_hover_color {
		" . cmsmasters_color_css('border-color', $cmsmasters_option['cleanora' . '_' . $scheme . '_hover']) . "
	}
	...
	{$rule}.cmsmasters_dynamic_cart .cmsmasters_dynamic_cart_button .count_wrap:before,
	{$rule}.woocommerce-store-notice, 
	...
	{$rule}.woocommerce-checkout-payment .payment_methods .payment_box:after {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['cleanora' . '_' . $scheme . '_alternate']) . "
	}
	...
	{$rule}.select2-container.select2-container--focus .select2-dropdown--below {
		" . cmsmasters_color_css('border-top-color', $cmsmasters_option['cleanora' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.select2-container.select2-container--focus .select2-dropdown--above {
		" . cmsmasters_color_css('border-bottom-color', $cmsmasters_option['cleanora' . '_' . $scheme . '_border']) . "
	}
	...
	{$rule}.comment-form-rating .stars > span {
		color:rgba(" . cmsmasters_color2rgb($cmsmasters_option['cleanora' . '_' . $scheme . '_secondary']) . ", .3);
	}
...
add_filter('cleanora_theme_colors_secondary_filter', 'cleanora_woocommerce_colors');
