...
function cleanora_get_admin_page() {
	global $pagenow;
...
function cleanora_default_tab() {
	$current_page = cleanora_get_admin_page();
...
function cleanora_get_the_tab() {
	global $pagenow;
	
	$default_tab = cleanora_default_tab();
...
function cleanora_settings_page_header() {
