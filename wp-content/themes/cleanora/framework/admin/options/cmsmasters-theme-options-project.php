...
if (!function_exists('cleanora_get_custom_project_meta_fields')) {
function cleanora_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['cleanora' . '_portfolio_project_title']) && $cmsmasters_option['cleanora' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['cleanora' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['cleanora' . '_portfolio_project_details_title']) && $cmsmasters_option['cleanora' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['cleanora' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['cleanora' . '_portfolio_project_share_box']) && $cmsmasters_option['cleanora' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['cleanora' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['cleanora' . '_portfolio_project_author_box']) && $cmsmasters_option['cleanora' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['cleanora' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['cleanora' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['cleanora' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = cleanora_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'cleanora'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'cleanora'), 
			'desc'	=> esc_html__('Don\'t Show', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'cleanora'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'cleanora'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'cleanora'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'cleanora'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Video Type', 'cleanora'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'embedded' => array( 
					'label' => esc_html__('Embedded (YouTube, Vimeo)', 'cleanora'), 
					'value'	=> 'embedded' 
				), 
				'selfhosted' => array( 
					'label' => esc_html__('Self-Hosted', 'cleanora'), 
					'value'	=> 'selfhosted' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Embedded Video Link', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Self-Hosted Video Links', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Title', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'cleanora'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio', 'cleanora') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image', 'cleanora'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'cleanora'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'cleanora') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'cleanora'), 
			'desc'	=> esc_html__('Open link in a new tab', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('About Author Box', 'cleanora'), 
			'desc'	=> esc_html__('Show', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('More Posts Box', 'cleanora'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'related' => array( 
					'label' => esc_html__('Show Related Tab', 'cleanora'), 
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => esc_html__('Show Popular Tab', 'cleanora'), 
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => esc_html__('Show Recent Tab', 'cleanora'), 
					'value'	=> 'recent' 
				), 
				'hide' => array( 
					'label' => esc_html__('Hide More Posts Box', 'cleanora'), 
					'value'	=> 'hide' 
				) 
			) 
		), 
