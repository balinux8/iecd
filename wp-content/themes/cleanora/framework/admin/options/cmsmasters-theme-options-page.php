...
if (!function_exists('cleanora_get_custom_page_meta_fields')) {
function cleanora_get_custom_page_meta_fields() {
	$cmsmasters_option = cleanora_get_global_options();
	
	
	$cmsmasters_global_layout = (isset($cmsmasters_option['cleanora' . '_layout']) && $cmsmasters_option['cleanora' . '_layout'] !== '') ? $cmsmasters_option['cleanora' . '_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_header_overlaps = (isset($cmsmasters_option['cleanora' . '_header_overlaps']) && $cmsmasters_option['cleanora' . '_header_overlaps'] !== '') ? (($cmsmasters_option['cleanora' . '_header_overlaps'] == 1) ? 'true' : 'false') : 'false';
	...
	$custom_page_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Header Overlaps Content', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Disabled Heading Block', 'cleanora'), 
			'desc'	=> esc_html__('Use this checkbox to disable heading block', 'cleanora'), 
