...
if (!function_exists('cleanora_get_custom_post_meta_fields')) {
function cleanora_get_custom_post_meta_fields() {
	$cmsmasters_option = cleanora_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['cleanora' . '_blog_post_layout']) && $cmsmasters_option['cleanora' . '_blog_post_layout'] !== '') ? $cmsmasters_option['cleanora' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['cleanora' . '_blog_post_title']) && $cmsmasters_option['cleanora' . '_blog_post_title'] !== '') ? (($cmsmasters_option['cleanora' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['cleanora' . '_blog_post_share_box']) && $cmsmasters_option['cleanora' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['cleanora' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['cleanora' . '_blog_post_author_box']) && $cmsmasters_option['cleanora' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['cleanora' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['cleanora' . '_blog_more_posts_box'])) ? $cmsmasters_option['cleanora' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'cleanora'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'cleanora'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'cleanora'), 
		...
		array( 
			...
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'cleanora'), 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'cleanora'), 
			'desc'	=> '', 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'cleanora'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'cleanora'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'cleanora'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'cleanora'), 
			'desc'	=> '', 
